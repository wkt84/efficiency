...
void BrachyMaterial::DefineMaterials()
{
  ...
  A = 107.87*g/mole;
  G4Element* elAg = new G4Element("Silver", "Ag", Z = 47., A);
  ...
  A = 195.084*g/mole;
  d = 21.45*g/cm3;
  platinum = new G4Material("platinum", Z = 78.,A, d);
  ...
  matsteel->AddElement(elCr, 0.17);
  matsteel->AddElement(elNi, 0.12);
  ...
  //PMMA
  d = 1.19*g/cm3;
  PMMA = new G4Material("PMMA",d, 3);
  PMMA->AddElement(elH, 0.0805);
  PMMA->AddElement(elC, 0.5998);
  PMMA->AddElement(elO, 0.3197); 

  //glass
  d = 2.61*g/cm3;
  glass = new G4Material("glass", d, 5);
  glass->AddElement(elP, 0.3155);
  glass->AddElement(elO, 0.5116);
  glass->AddElement(elAl, 0.0612);
  glass->AddElement(elNa, 0.11);
  glass->AddElement(elAg, 0.0017);
}
